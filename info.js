let info = {
  name: "Triệu Hồng Ký",
  logo_name: "HongKy",
  flat_picture: require("./src/assets/avatar-removebg-preview.png"),
  config: {
    use_cookies: true,
    navbar: {
      blur: false,
  ...
  links: {
    ...
    envelope: "trieuhongky11112003@gmail.com",
  },
  education: [
    {
      name: "E-commerce Website",
      place: "Dự Án 1",
      date: "6/11/2022 - 28/12/2022",
      degree: "Website bán hàng tích hợp thanh toán VNPT",
      description:
        "Website E-commerce đầy đủ chức năng mua hàng, thanh toán, xác thực email khi đăng ký tài khoản.",
      // eslint-disable-next-line no-sparse-arrays
      skills: ["HTML", "CSS", "JavaScript", "PHP", "MySQL", "AJAX "],
    },
    {
      name: "Website Tìm Kiếm Việc Làm",
      place: "Dự Án Tốt Nghiệp",
      date: "3/9/2023 - 23/12/2023",
      degree: "Website tìm kiếm việc làm và nộp hồ sơ ứng tuyển",
      description:
        "Gồm các chức năng riêng biệt cho từng loại tài khoản ứng viên và doanh nghiệp, đăng tin tuyển dụng, cập nhật hồ sơ, ứng tuyển việc làm, mua gói công việc yêu thích, duyệt hồ sơ ứng viên và gửi mail, giao diện tối.",
      skills: [
        "HTML",
        "CSS",
        "Tailwind",
  ...
  experience: [
    {
      name: "Dự Án Quản Lý Quán Ăn",
      place: "68FOOD",
      date: "5/1/2024 - Hiện tại",
      position: "Website và ứng dụng quản lý quán ăn",
      description:
        "Website quản lý quán ăn, đặt món, đặt bàn, quản lý doanh thu và số lượng nguyên liệu hàng ngày, tuần, xuất nhập kho, quản lý và xuất hóa đơn, quản lý khuyến mãi, quản lý công nợ khi nhập kho và nợ của khách hàng.",
      skills: [
        "PHP",
        "Laravel",
        "Filament",
  ...
  skills: [
    ...
    {
      title: "Công Nghệ",
      info: ["Vue JS", "Laravel", "HTML", "CSS", "Tailwind", "Bootstrap"],
  ...
  portfolio: [
    {
      name: "Dự Án Website Tìm Kiếm Việc Làm",
      pictures: [
        {
          img: require("./src/assets/portfolio/TVKG/one.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/two.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/three.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/four.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/five.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/eight.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/nine.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/ten.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/six.png"),
        },
        {
          img: require("./src/assets/portfolio/TVKG/seven.png"),
        },
      ],
      technologies: [
        "HTML",
    ...
    },
    {
      ...
      pictures: [
        {
          img: require("./src/assets/portfolio/68Food/logo.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/one.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/two.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/three.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/four.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/five.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/six.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/QR1.png"),
        },
        {
          img: require("./src/assets/portfolio/68Food/QR2.png"),
        },
      ],
      technologies: [
        "PHP",
      ...
      category: "Website",
      date: "5/1/2024 - Hiện tại",
      github: "https://github.com/tinhpv10/PolySoftware68FoodBackEnd.git",
      visit: "https://github.com/tinhpv10/PolySoftware68FoodBackEnd.git",
      description:
        "Dự án website và ứng dụng quản lý quán ăn, đặt món, đặt và gộp, tách bàn,thống kê doanh thu và số lượng nguyên liệu sử dụng trong ngày, tuần, tháng, xuất nhập kho, quản lý và xuất hóa đơn, quản lý khuyến mãi, quản lý công nợ khi nhập kho và nợ của khách hàng. Trang quản lý bao gồm nhiều vai trò như nhân viên Order, nhân viên bếp, nhân viên thu ngân, nhân viên quản lý và mỗi vai trò sẽ có các chức năng và quyền thao tác khác nhau.",
    },
    // {
    //   name: "POST",
    //   pictures: [
